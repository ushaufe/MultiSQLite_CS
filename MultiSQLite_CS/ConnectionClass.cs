...
namespace MultiSQLite_CS
{
    public class ConnectionClass
    {
        ...
        public ConnectionClass(Form form, PromptCommands prompt, String appName, String strAppData)
        {
            this.form = form;
            this.appName = appName;
            this.prompt = prompt;
            prompt.connection = this;
            this.strAppData = strAppData;
        }
        ...
        {            
            strDatabaseFile = strAppData + DB_FILE;
            ...
            if (con.State == ConnectionState.Open)
            {
                ...
                if (dbVersion < 1100)
                {
                    ...
                    execQuery("insert into multisqlite_version (id,name,version) values (0,'MultiSQLite_CS', '" + "1.1.0.0" + "')");
                    dbVersion = 1100;                    
                }
        ...
        public String getDBVersion()
        {
            ...
            if (!strName.ToUpper().Equals("MultiSQLite_CS"))
                return "0";
            else
